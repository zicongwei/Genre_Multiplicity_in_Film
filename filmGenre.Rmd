...
Hollywood as a mass culture was trying to challenge the imperative to work and the serious atmosphere. Musicals defensed the pleasure of US popular cultures and various forms of entertainment[^4].  
...
By analyzing the genre coverage of films recorded in IMDB, we found that vast scale of social and technological changes may reshape the film industry’s genre composition. However, we also found that some trends seem to be immune to the changing waves. For example, the composition of musical has not changed a lot across film history.
