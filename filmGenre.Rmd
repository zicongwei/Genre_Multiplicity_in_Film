...
The first plot shows that this number reached it peak around 1940s and dramatically decreased after that period. It started increasing greatly again in 2000s. There should be some events at that time to explain the drastic changes.  

Also, the increase from 2006 indicates that movies made today tend to have overlapping genres that are different form the past. Old movies tended to fit squarely in one genre, while more recent movies tend to span multiple genres.

```{r message=FALSE, echo=TRUE, warning=FALSE, fig.align="center", fig.width=10, fig.height=6.5}
plot2
```
Plot2 presents the proportion of films' genres in each year. Some genres have important influence on the genre overlapping.      
...
After this classical period, musicals were no longer favored by the public, especially the old-fashion hollywood musicals. Since 1960s, lots of social movements impacted the society. Especially young people’s music tastes have changed, because the influence of rock and roll and new popular cultures.  

During 1980s to 1990s, animated films became popular with musicals, such as Disney's films *Beauty and the Beast* and *Lion King*. They all became blockbuster successes.   

In the 21st century, the musicals film was reborn. Drama musicals and comedy-drama musicals such as Chicago and La La Land become more popular in musical genres. In recent years, animated musicals like Frozen and Coco also gained popularity among people. 
